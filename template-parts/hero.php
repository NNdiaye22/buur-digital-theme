<?php
/**
 * BUUR Digital — Hero v4
 * Fond : vidéo OU photo selon le Customizer (buur_hero_bg_type)
 */
  ...
  <div class="hero-video-bg" aria-hidden="true">
    ...
    <?php else : ?>
      <video
        ...
        aria-hidden="true"
      >
        <source src="<?php echo esc_url( BUUR_URI . '/assets/videos/hero-loop.mp4' ); ?>" type="video/mp4">
      </video>
    <?php endif; ?>
