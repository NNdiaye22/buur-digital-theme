...
function buur_enqueue_assets() {
    ...
    // --- JS homepage : GSAP + vidéos ---
    if ( is_front_page() ) {

        // GSAP CDN (ScrollTrigger inclus)
        wp_enqueue_script(
            'gsap',
        ...
        wp_enqueue_script(
            'buur-video-manager',
            BUUR_URI . '/assets/js/video-manager.js',
            array(),
            BUUR_VERSION,
            true
        );
        wp_enqueue_script(
            'buur-hero-tunnel',
            BUUR_URI . '/assets/js/hero-tunnel.js',
            array( 'threejs', 'gsap-scrolltrigger' ),
            BUUR_VERSION,
            true
        );
        wp_enqueue_script(
            'buur-gsap-animations',
            BUUR_URI . '/assets/js/gsap-animations.js',
            array( 'gsap-scrolltrigger', 'gsap-splittext', 'buur-video-manager' ),
            BUUR_VERSION,
            true
        );
    }
