      ...
      <div class="tarifs-grid">
        ...
        <article class="tarif-card">
          ...
          <ul class="tarif-list">
            ...
            <li><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>Nom de domaine inclus 1 an</li>
    ...
    <div class="tarifs-container">
      ...
      <dl class="tarifs-faq-list">
        ...
        <div class="tarifs-faq-item">
          ...
          <dd class="tarifs-faq-item__a">Oui, il est inclus sur les offres one shot la première année et inclus dans BUUR Site selon la formule.</dd>
        </div>
